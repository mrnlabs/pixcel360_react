                              ...
                              <div className="flex items-center flex-wrap">
                                <div className={`avatar avatar-xl ${shuffleBGs(BGs)[index]} !text-primary me-2 flex-shrink-0`}>
                                  <div className="text-center">
                                    <div className=" font-medium leading-none mb-1">{format(parseISO(event?.start_date), 'dd')}</div>
                                    <div className="text-xs text-defaulttextcolor font-medium leading-none">{format(parseISO(event?.start_date), 'EEE')}</div>
                                  </div>
                                </div>
                                <div className="flex flex-wrap flex-auto items-top justify-between flex-xl-nowrap">
                                  <div className="events-width">
                                    ...
                                    <p className="mb-0 text-xs leading-none text-textmuted dark:text-textmuted/50">{format(parseISO(event.start_date), 'HH:mm')} 
