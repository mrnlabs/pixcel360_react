        ...
        <div className="text-center">
          <div className="mb-2">
            <span className={`avatar avatar-xl avatar-rounded  ${user && isRecentlyLogin(user) ? 'online' : 'offline'}`}>
              <img src={user?.photo ?? 'https://pixcelcapetown.s3.af-south-1.amazonaws.com/placeholders/profile_placeholder.png'} alt=""/>
            </span>
          </div>
          ...
          <div className="flex gap-2 mb-0 flex-wrap flex-xxl-nowrap">
            <Link href={route('users.show',user?.slug)} className="ti-btn bg-[linear-gradient(243deg,#ffcc00_0%,#ff9339_100%)] text-white ti-btn-sm mb-0 flex-auto"> View More </Link>
