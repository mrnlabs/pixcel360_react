...
const FullScreen = () => {
  ...
  return (
    ...
    <li className="header-element header-fullscreen">
                ...
                {isFullscreen ? (
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 full-screen-close header-link-icon " fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
